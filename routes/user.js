...
exports.logout=function(req,res){
    ...
    res.render('./Module4/logout',{loggedOutUser:loggedOutUser});
}
...
exports.doCreate=function(req,res){
   ...
   newuser.save(function(err,savedUser){
       if(err){
         ...
         res.render("./Module4/register",{errorMessage:message});
         return;
       }else{
         req.session.newuser=savedUser.username;
         res.render("./Module4/new-user",{session:req.session});
       }
   });
}
...
exports.login=function(req,res){
    ...
    User.findOne({email:email}, function(err,user){
      ...
      if(user==null){
        ...
        res.render("./Module4/login",{errorMessage:message});
        return;
      }
